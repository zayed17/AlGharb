...
const ServiceFeature: React.FC = () => {
  return (
    <section className="bg-gradient-to-r from-blue-50 via-white to-blue-50 py-10 md:py-16 px-4 md:px-8">
      <div className="container mx-auto max-w-7xl flex flex-col md:flex-row items-center md:justify-between gap-8">
        <div className="md:w-1/2">
          <h2 className="text-[clamp(1.5rem,4vw,2rem)] font-extrabold text-customBlue mb-4 leading-tight">
        ...
        <div className="md:w-1/2 flex justify-center">
          <Image src="/service.jpg" alt="Client meeting" className="rounded-xl shadow-lg max-w-full h-auto" width={800} height={600} sizes="(min-width: 1024px) 600px, 100vw" />
        </div>
      </div>
    </section>
  );
